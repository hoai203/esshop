...
})({"hayy6":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3f53c01ec5fb7769";
"use strict";
...
},{}],"3VoR5":[function(require,module,exports) {
...
var _orderDetailService = require("./OrderDetailService");
...
for (const adddev of cartItems)list += `
...
$("#addOrder").on("click", ()=>{
    ...
    if (name == "" || phone == "" || email == "" || address == "") alert("Kh\xf4ng Được Để Trống");
    else try {
        orderService.insertUsers(orders).then((data)=>{
            idOrder.val(data);
            for (const product of cartItems){
                const orderDetail = new (0, _orderDetailsDefault.default)(data, product.productId, product.quantity, product.product.price);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../models/Orders":"aPftK","../constants/FirebaseConstants":"ar8Y5","./OrderService":"dPfIm","./OrderDetailService":"cQ5Ze","../models/OrderDetails":"5hoAm"}],"aPftK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hayy6","3VoR5"], "3VoR5", "parcelRequirec720")

//# sourceMappingURL=checkout.c5fb7769.js.map
