...
})({"gCxzw":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8dda4d893ef792fa";
"use strict";
...
},{}],"gwf5n":[function(require,module,exports) {
...
var _categoryService = require("../../services/category/CategoryService");
...
$(document).ready(function() {
    ...
    productService.findById(id).then((data)=>{
        console.log(data);
        const { categoryId , nameProd: nameProd1 , img: img1 , quantity , price: price1 , description: description1  } = data;
        categoryIdCtrl.val(categoryId);
        productIdCrlt.val(id);
        nameProdCtrl.val(nameProd1);
        quantityCtrl.val(quantity);
        imgCtrl.val(img1);
        priceCtrl.val(price1);
        descriptionCtrl.val(description1);
    });
    $("#update").on("click", ()=>{
        const prd = new (0, _product.Product)(categoryIdCtrl.val(), null, nameProdCtrl.val(), imgCtrl.val(), descriptionCtrl.val(), priceCtrl.val(), quantityCtrl.val());
        // console.log(prd);
        if (nameProd == "" || img == "" || price == "" || description == "") alert("Kh\xf4ng Được Để Trống");
        else try {
...
},{"regenerator-runtime/runtime":"dXNgZ","../../constants/FirebaseConstants":"ar8Y5","../../helpers/UrlHelper":"9C87C","../../models/category":"2L7K1","../../models/product":"kTfa7","../../services/category/CategoryService":"gSRAy","./ProductService":"fVatA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9C87C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2L7K1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Category {
    constructor(caregogyId, nameCate){
        this.caregogyId = caregogyId;
        this.nameCate = nameCate;
    }
}
exports.default = Category;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kTfa7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Product", ()=>Product);
class Product {
    constructor(categoryId, productId, nameProd, img, description, price, quantity){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gSRAy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class CategoryService {
    ...
    insertCategory = async (entity)=>{
        ...
        const insertedId = await response.data.nameCate;
        return insertedId;
    };
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fVatA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
class ProductService {
    ...
    updateProduct = async (id, entity)=>{
        const response = await (0, _axiosDefault.default).put(`${this.realtimeDb}produts/${id}.json `, entity);
        return response.data;
    };
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gCxzw","gwf5n"], "gwf5n", "parcelRequirec720")

//# sourceMappingURL=insertProduct copy.3ef792fa.js.map
